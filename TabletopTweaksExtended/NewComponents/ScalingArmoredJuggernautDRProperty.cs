...
namespace TabletopTweaksExtended.NewComponents
{
    ...
    public class ScalingArmoredJuggernautDRProperty : PropertyValueGetter
    {
        ...
        public override int GetBaseValue(UnitEntityData unit)
        {
            ...
            g.Key = Resources.GetTabletopTweaksBlueprint<BlueprintFeature>("ArmorTrainingFlag").ToReference<BlueprintFeatureReference>();
