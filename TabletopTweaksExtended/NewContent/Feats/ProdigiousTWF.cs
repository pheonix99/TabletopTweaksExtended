...
namespace TabletopTweaksExtended.NewContent.Feats
{
    static class ProdigiousTWF
    {
        ...
        public static void AddProdigiousTWF()
        {
            ...
            AlterTWFFeatCascade();
            FeatTools.Selections.RangerStyleTwoHandedSelection2.AddFeatures(new BlueprintFeature[] { ProdigiousTWF });
            FeatTools.Selections.RangerStyleTwoHandedSelection6.AddFeatures(new BlueprintFeature[] { ProdigiousTWF });
            FeatTools.Selections.RangerStyleTwoHandedSelection10.AddFeatures(new BlueprintFeature[] { ProdigiousTWF });
            

            FeatTools.Selections.RangerStyleShieldSelection2.AddFeatures(new BlueprintFeature[] { ProdigiousTWF });
            FeatTools.Selections.RangerStyleShieldSelection6.AddFeatures(new BlueprintFeature[] { ProdigiousTWF });
            FeatTools.Selections.RangerStyleShieldSelection10.AddFeatures(new BlueprintFeature[] { ProdigiousTWF });
